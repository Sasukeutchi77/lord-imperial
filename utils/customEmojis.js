// LORD IMPERIAL — 80 custom emojis exclusifs
...
// SVG definitions for all 80 emojis
const SVGS = {
  // ── ROYAUTÉ ──────────────────────────────────────────────────────────────
  ...
  li_black_hole: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <radialGradient id="g" cx="50%" cy="50%"><stop offset="0%" stop-color="#000000"/><stop offset="35%" stop-color="#1A0030"/><stop offset="65%" stop-color="#3D0070"/><stop offset="100%" stop-color="#0D1117"/></radialGradient>
    </defs>
    ...
    <path d="M8,26 Q16,32 8,38" fill="none" stroke="rgba(124,58,237,0.3)" stroke-width="1.5"/>
    <path d="M56,26 Q48,32 56,38" fill="none" stroke="rgba(124,58,237,0.3)" stroke-width="1.5"/>
  </svg>`,

  li_nova: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <radialGradient id="g" cx="50%" cy="50%"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="20%" stop-color="#FFF176"/><stop offset="60%" stop-color="#FF6B00"/><stop offset="100%" stop-color="#7C0000"/></radialGradient>
    </defs>
  ...
  li_comet: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="g" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="rgba(167,139,250,0)"/><stop offset="70%" stop-color="rgba(167,139,250,0.4)"/><stop offset="100%" stop-color="#A78BFA"/></linearGradient>
    </defs>
    <path d="M6,58 Q20,40 48,16" stroke="url(#g)" stroke-width="8" stroke-linecap="round" fill="none"/>
    <path d="M10,54 Q22,42 46,20" stroke="rgba(255,255,255,0.15)" stroke-width="3" stroke-linecap="round" fill="none"/>
    <circle cx="50" cy="14" r="8" fill="#DDD6FE" stroke="#7C3AED" stroke-width="2"/>
    <circle cx="48" cy="12" r="3" fill="rgba(255,255,255,0.8)"/>
    <circle cx="20" cy="50" r="2" fill="#A78BFA" opacity="0.5"/>
    <circle cx="14" cy="56" r="1.5" fill="#A78BFA" opacity="0.3"/>
  </svg>`,
  ...
  li_nebula: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <circle cx="18" cy="52" r="1" fill="white" opacity="0.6"/>
    <circle cx="32" cy="32" r="1.5" fill="white"/>
    <circle cx="42" cy="18" r="1" fill="white" opacity="0.8"/>
  </svg>`,

  li_astral: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="g" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#60A5FA"/><stop offset="50%" stop-color="#A78BFA"/><stop offset="100%" stop-color="#F0ABFC"/></linearGradient>
    </defs>
    <circle cx="32" cy="32" r="28" fill="#0D1117"/>
    ...
    <circle cx="58" cy="32" r="3" fill="#60A5FA" opacity="0.8"/>
    <circle cx="6" cy="32" r="3" fill="#60A5FA" opacity="0.8"/>
    <circle cx="32" cy="6" r="2" fill="#F0ABFC" opacity="0.7"/>
    <circle cx="32" cy="58" r="2" fill="#F0ABFC" opacity="0.7"/>
  </svg>`,

  li_eclipse: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <radialGradient id="sun" cx="50%" cy="50%"><stop offset="0%" stop-color="#FDE68A"/><stop offset="60%" stop-color="#F59E0B"/><stop offset="100%" stop-color="#92400E"/></radialGradient>
    </defs>
    ...
    <circle cx="10" cy="48" r="1" fill="white" opacity="0.6"/>
    <path d="M10,32 Q14,24 20,32" fill="none" stroke="#F59E0B" stroke-width="1.5" opacity="0.5"/>
    <path d="M54,32 Q50,24 44,32" fill="none" stroke="#F59E0B" stroke-width="1.5" opacity="0.5"/>
  </svg>`,
  ...
  li_hexagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <circle cx="8" cy="32" r="2" fill="#A78BFA" opacity="0.6"/>
    <circle cx="56" cy="32" r="2" fill="#A78BFA" opacity="0.6"/>
  </svg>`,

  li_eye_of_fate: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <radialGradient id="iris" cx="50%" cy="50%"><stop offset="0%" stop-color="#60A5FA"/><stop offset="40%" stop-color="#2563EB"/><stop offset="100%" stop-color="#1E3A8A"/></radialGradient>
    </defs>
    ...
    <circle cx="32" cy="32" r="2" fill="#60A5FA" opacity="0.5"/>
    <path d="M4,32 Q20,20 32,20 Q44,20 60,32" fill="none" stroke="rgba(37,99,235,0.4)" stroke-width="1"/>
    <path d="M4,32 Q20,44 32,44 Q44,44 60,32" fill="none" stroke="rgba(37,99,235,0.4)" stroke-width="1"/>
  </svg>`,
  ...
  li_serpent: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M30,60 L28,63 M34,60 L36,63" stroke="#10B981" stroke-width="1.5" stroke-linecap="round"/>
  </svg>`,

  li_crystal_skull: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="g" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="rgba(167,139,250,0.9)"/><stop offset="100%" stop-color="rgba(76,29,149,0.7)"/></linearGradient>
    </defs>
    ...
    <path d="M20,16 L26,24 M32,12 L32,22 M44,16 L38,24" stroke="rgba(167,139,250,0.5)" stroke-width="1"/>
  ...
  li_grimoire: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <line x1="20" y1="52" x2="30" y2="52" stroke="#7C3AED" stroke-width="1.5" stroke-linecap="round"/>
  </svg>`,
  ...
  li_potion: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="liq" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="#C084FC"/><stop offset="100%" stop-color="#7C3AED"/></linearGradient>
    </defs>
    ...
    <circle cx="30" cy="30" r="2.5" fill="rgba(167,139,250,0.4)"/>
  </svg>`,
  ...
  li_elixir: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      ...
      <linearGradient id="glass" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="rgba(110,231,183,0.2)"/><stop offset="100%" stop-color="rgba(6,95,70,0.1)"/></linearGradient>
    </defs>
    <path d="M24,8 L24,20 L10,44 Q8,54 32,56 Q56,54 54,44 L40,20 L40,8 Z" fill="url(#glass)" stroke="#10B981" stroke-width="2"/>
    <path d="M14,44 L14,50 Q14,54 32,54 Q50,54 50,50 L50,44 Z" fill="url(#liq)"/>
    <ellipse cx="32" cy="44" rx="18" ry="4" fill="rgba(110,231,183,0.3)"/>
    <rect x="22" y="6" width="20" height="6" rx="3" fill="#94A3B8" stroke="#64748B" stroke-width="1.5"/>
    <path d="M16,34 Q24,28 32,32 Q40,28 48,34" fill="none" stroke="rgba(110,231,183,0.4)" stroke-width="1.5"/>
  ...
  li_philosopher_stone: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <radialGradient id="g" cx="40%" cy="35%"><stop offset="0%" stop-color="#FDE68A"/><stop offset="40%" stop-color="#FF4500"/><stop offset="100%" stop-color="#7C0000"/></radialGradient>
    </defs>
    ...
    <ellipse cx="29" cy="29" rx="2.5" ry="1.5" fill="rgba(255,255,255,0.5)" transform="rotate(-20,29,29)"/>
  </svg>`,
  ...
  li_mercury: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M26,56 Q32,60 38,56" fill="none" stroke="url(#g)" stroke-width="2" stroke-linecap="round"/>
  </svg>`,
  ...
  li_rage_face: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M10,14 Q14,8 18,12" fill="none" stroke="#FFD700" stroke-width="2" stroke-linecap="round"/>
    <path d="M54,14 Q50,8 46,12" fill="none" stroke="#FFD700" stroke-width="2" stroke-linecap="round"/>
  </svg>`,
  ...
  li_war_horn: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M20,30 Q28,32 20,36" fill="none" stroke="#D97706" stroke-width="1.5" opacity="0.5"/>
    <path d="M28,28 Q38,32 28,38" fill="none" stroke="#D97706" stroke-width="1.5" opacity="0.4"/>
  </svg>`,
  ...
  li_berserker: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M16,12 L22,18" stroke="url(#g)" stroke-width="3" stroke-linecap="round"/>
    <path d="M48,12 L42,18" stroke="url(#g)" stroke-width="3" stroke-linecap="round"/>
    ...
    <path d="M24,50 L40,50" stroke="#FFD700" stroke-width="2" stroke-linecap="round"/>
  </svg>`,
  ...
  li_inferno_fist: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M22,22 Q28,18 36,20 Q40,22 42,28" fill="none" stroke="#FF4500" stroke-width="1.5" opacity="0.6"/>
  ...
  li_thunderclap: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M10,8 Q28,4 32,24 Q36,4 54,8 Q44,22 40,28 L54,28 L24,60 L32,36 L10,36 Z" fill="none" stroke="rgba(255,255,255,0.6)" stroke-width="1"/>
  ...
  li_empire_flag: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <text x="31" y="42" text-anchor="middle" font-size="7" fill="#C9956B" font-family="serif" font-weight="bold">LI</text>
  </svg>`,
  ...
  li_victor_wreath: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs><linearGradient id="g" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#4ADE80"/><stop offset="100%" stop-color="#166534"/></linearGradient><linearGradient id="gld" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#FFD700"/><stop offset="100%" stop-color="#D97706"/></linearGradient></defs>
  ...
  li_imperial_eagle: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M28,20 Q32,16 36,20" fill="none" stroke="#FFD700" stroke-width="2"/>
    <ellipse cx="29" cy="22" rx="2.5" ry="2.5" fill="#FFD700"/>
    <ellipse cx="35" cy="22" rx="2.5" ry="2.5" fill="#FFD700"/>
    <ellipse cx="29" cy="23" rx="1.2" ry="1.5" fill="#0D1117"/>
    <ellipse cx="35" cy="23" rx="1.2" ry="1.5" fill="#0D1117"/>
  ...
  li_crown_of_thorns: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    ...
    <path d="M8,44 Q32,50 56,44" fill="none" stroke="#92400E" stroke-width="2"/>
